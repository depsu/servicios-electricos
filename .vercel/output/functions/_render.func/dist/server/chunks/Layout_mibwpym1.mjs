import { b as createAstro, c as createComponent, a as renderTemplate, d as addAttribute, m as maybeRenderHead, j as renderSlot, i as renderScript, r as renderComponent, k as createTransitionScope, l as renderHead, u as unescapeHTML } from './astro/server_BoL8rYyb.mjs';
import 'piccolore';
/* empty css                          */
import 'clsx';
...
Desarrollado por <a href="https://paginasfast.cl" target="_blank" rel="noopener" class="font-bold text-slate-500 hover:text-blue-600 transition-colors uppercase tracking-wider">PÁGINASFAST</a> </p> </div> </div> </div> </footer>`;
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  const canonicalPath = Astro2.url.pathname.endsWith("/") ? Astro2.url.pathname : `${Astro2.url.pathname}/`;
  const canonicalURL = new URL(canonicalPath, Astro2.site ?? Astro2.url.origin).href;
  const fontConfig = {
    sans: {
